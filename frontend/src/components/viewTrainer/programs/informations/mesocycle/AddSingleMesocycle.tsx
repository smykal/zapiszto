...
const AddSingleMesocycle: React.FC<AddMesocycleFormProps> = ({ macrocycleId, onMesocycleAdded }) => {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    try {
      await MesocycleService.addSingleMesocycle(newMesocycle, macrocycleId);
...
export default AddSingleMesocycle;
